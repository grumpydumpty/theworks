...
RUN tdnf update -y && \
    ...
    tdnf install -y ansible bash ca-certificates cdrkit coreutils curl diffutils gawk git htop jq mc nodejs openssh python3 python3-jinja2 python3-paramiko python3-pip python3-pyyaml python3-resolvelib python3-xml shadow tar tmux unzip vim && \
    # add user/group
